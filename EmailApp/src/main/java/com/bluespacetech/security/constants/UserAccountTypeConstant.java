...
public enum UserAccountTypeConstant {
	...
	ACC_TYPE_SUPER_ADMIN("ACC_TYPE_SUPER_ADMIN"), ACC_TYPE_ADMIN(
			"ACC_TYPE_ADMIN"), ACC_TYPE_EMPLOYEE("ACC_TYPE_EMPLOYEE"), ACC_TYPE_TEACHER(
					"ACC_TYPE_TEACHER"), ACC_TYPE_STUDENT("ACC_TYPE_STUDENT"), ACC_TYPE_PARENT("ACC_TYPE_PARENT"),ACC_TYPE_USER("ACC_TYPE_USER"),;
